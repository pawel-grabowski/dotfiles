...
alias la='ls -A' # show hidden (prefixed with . )
alias lf='ls -CF' # in columns, with indicators
# ( with / for directories, * for executable files, @ for symbolic links, and = for sockets.)
alias ll='exa -alF' # hidden + long format + indicator

# common ops, -i ask for confirmation
alias rm="rm -i"
alias cp="cp -i"
alias mv="mv -i"
alias ..="cd .."
...
alias gd='g diff' # View the difference.
